...
namespace Ruler {
  ...
  internal static class Updater {
    ...
    private const string GITHUB_LANDING_PAGE = "sergiye/ruler";
    ...
    internal static string GetJsonData(string uri, int timeout = 10, string method = "GET") {
    ...
    internal static void CheckForUpdates() {
      ...
      try {
        ...
        var releases = DeserializeJson<GitHubRelease[]>(jsonString) as GitHubRelease[];
